...
static EFI_GUID GUID_CISCO = { 0x7dc87112, 0x2bd5, 0x4154, { 0x95, 0x0a, 0xce, 0x31, 0x83, 0x10, 0x76, 0x19 }} ;
...
{
	char *variables[] = { "MokList" ,"PK", "KEK", "db", "dbx" , "PKCisco", "KEKCisco", "dbCisco", "dbxCisco" };
	EFI_GUID *owners[] = { &MOK_OWNER, &GV_GUID, &GV_GUID, &SIG_DB, &SIG_DB, &GUID_CISCO ,&GUID_CISCO ,&GUID_CISCO ,&GUID_CISCO };
